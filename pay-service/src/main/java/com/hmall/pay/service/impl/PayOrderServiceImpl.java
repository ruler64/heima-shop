...
//        tradeClient.markOrderPaySuccess(po.getBizOrderNo());
        // 发送者确认机制方法二：publisher-confirm
        CorrelationData cd = new CorrelationData(UUID.randomUUID().toString());//创建correlationData作为发送的消息的唯一id
        cd.getFuture().addCallback(new ListenableFutureCallback<CorrelationData.Confirm>() {//异步处理未来的结果
            @Override
