...
public class ElasticDocumentTest {
    ...
    @Test
    void testIndexDoc() throws IOException {//若id不存在则新增文档，若id存在则全量修改文档
        // 0.准备文档数据
        // 0.1.根据id查询数据库数据
    ...
    @Test
    void testGetDoc() throws IOException {//查询文档
        // 1.准备Request
    ...
    @Test
    void testDeleteDoc() throws IOException {//删除文档
        // 1.准备Request
    ...
    @Test
    void testUpdateDoc() throws IOException {//局部更新文档
        // 1.准备Request
    ...
    @Test
    void testBulkDoc() throws IOException {//批量增加/删除/更改
